...
Core provides definitions, sector profiles, `benchmarks.yaml` guardrails, and formula inputs. The platform provides peer cohorts, normalization, gap analytics, waterfalls, and improvement workflows.
