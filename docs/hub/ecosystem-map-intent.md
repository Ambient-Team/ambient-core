...
- Founder Uni curriculum and Pass / Master / Finish progress: commercial/learning/founder-uni/ (hub-owned). Spoke expectations and return shape live there; no commercial/learning dispatch rule in the Focused pass. Returns may cite fu-week and fu-level per inbox/PROTOCOL.md.
