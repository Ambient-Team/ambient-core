...
- Hub-test customer package (production orchestration from vault): operations/customers/hub-test/. Commercial capture playbooks live here; platform demos no longer hold commercial media.
