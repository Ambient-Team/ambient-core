...
- CV SSOT: commercial/people/cv/ (was people/cv/)
- Sync: career-public-sync watches commercial/people/cv/** and job-search-targeting.md

### code-signal

- Hub package: spokes/code-signal/ (pointers only)
- Interview prep SSOT: commercial/people/interview-prep/
...
1. On next hub-sync PR, retarget path cites: people/cv to commercial/people/cv; product/engineering to spokes/platform/engineering; company/strategy/governance to interface/
