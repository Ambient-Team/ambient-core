...
YAML source of truth: contracts/ in Ambient-Team/ambient-core on pin v0.2.6 -- https://github.com/Ambient-Team/ambient-core/tree/v0.2.6/contracts (platform pins via submodule; see ambient-systems-platform docs/ambient-core.md).
