...
If you ship workflows on governed KPIs, pin ambient-core for catalog metrics, `benchmarks.yaml`, sector profiles, `ambient_calc`, and contracts (`quality-v1`, `operational-financial-bridge-v1`, and others). Implement tenancy, UI, and cycle-specific logic in your application repository:
